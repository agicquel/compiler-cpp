 ...
 * </p>
 * <ul>
 *   <li>{@link esir.comp.cpp.whileDsl.impl.CommandsImpl#getCommands <em>Commands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommandsImpl extends MinimalEObjectImpl.Container implements Commands
{
  ...
  {
    return WhileDslPackage.Literals.COMMANDS;
  }
  ...
  public EList<Command> getCommands()
  {
    if (commands == null)
    {
      commands = new EObjectContainmentEList<Command>(Command.class, this, WhileDslPackage.COMMANDS__COMMANDS);
    }
    return commands;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case WhileDslPackage.COMMANDS__COMMANDS:
